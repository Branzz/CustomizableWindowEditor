...
public class Window extends Applet implements MouseListener, KeyListener { //TODO at the end, go backwards really fast or keep cutting to random spots
...
//	private boolean tickUp;
	...
	public Window(ArrayList<Element> elements, int maxTime, JFrame frame, int width, int height) {
...
//			System.out.println(elements.get(i).getEnterTime() + " <= " + time + " && " + elements.get(i).getDieTime() + " >= " + time);
		...
		/*     A timed event for showing the time slider at the bottom
